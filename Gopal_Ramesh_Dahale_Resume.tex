...
\begin{scope}[every node/.append style={box}]
    \node {
        \cvevent{SWE Summer Intern}{\href{https://meetai.in/}{\underline{MeetAI}}}{May 2021 - July 2021}{Remote}
        \begin{itemize}
        \item Revamped the \textbf{UI/ UX} by of the project \textbf{{\href{https://telgro.in/}{\underline{(Telgro)}}}} by implementing Material-UI styling.
        \item Desgined and implemented \textbf{RESTful APIs} in Django.
        \item Managed continuous \textbf{maintenance}, \textbf{troubleshooting} and \textbf{deployment of Frontend \& Backend}.
        \item Designed a \textbf{3PL item response model} to incorporate response time for \textbf{predicting student's response}. 
        \item Designed a \textbf{Lognormal RT model} for \textbf{predicting student's speed}. 
        \item Validated with \textbf{80\% accuracy} on synthetic data.  and \textbf{deployed the models/infrastructure} and software that uses these models.
        \item \textbf{Leveraged Knowledge of ReactJs, Django, Material-UI, Firebase, Heroku }
        \end{itemize}
        \divider
    } ;
    \node {
        \cvevent{SWE Winter Intern}{\href{https://www.newzera.com/}{\underline{Newzera}}}{Dec 2020 - Jan 2021}{Remote}
        \begin{itemize}
    ...
    \node {
        \cvevent{C++ Developer Intern}{\href{https://cppsecrets.com/user/index.php?uid=817}{\underline{cppsecrets.com}}}{Aug 2019 - Nov 2019}{Remote}
        \begin{itemize}
...
\cvsection{Strengths}
Proficient:
\cvtag{C/C++}\cvtag{Python}\cvtag{ReactJs}\cvtag{Firebase}

\divider

Familiar: 
\cvtag{Django}\cvtag{Kotlin}\cvtag{React Native}\cvtag{GraphQL}\cvtag{MySQL}\cvtag{Jest/Enzyme}\cvtag{Pytorch}\cvtag{Scikit-learn}\cvtag{Flask}\cvtag{Streamlit}\cvtag{\LaTeX}
